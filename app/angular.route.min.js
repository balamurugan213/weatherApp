	...
	var D,
		...
		y = b
			...
			.provider('$route', function(){
					...
					if (D(c)) {
						...
						for (g in ((f = f || {}), c))
							if (
								...
								f[g] = c[g]
					f = f || c
					b.isUndefined(f.reloadOnUrl) &&
						(f.reloadOnUrl = !0)
					b.isUndefined(f.reloadOnSearch) &&
						(f.reloadOnSearch = !0)
				...
				p = !0
				this.eagerInstantiationEnabled = function(
					b
				){
